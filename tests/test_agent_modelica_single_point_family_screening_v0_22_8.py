...
def _admitted_row(candidate_id: str = "v0228_a") -> dict:
    return {
        "candidate_id": candidate_id,
        "mutation_pattern": "single_point_capacitor_observability_refactor",
        ...
        "single_point_refactor_scope": "C1_observability_refactor",
...
class SinglePointFamilyScreeningV0228Tests(unittest.TestCase):
    def test_build_repair_case_omits_hidden_family_metadata(self) -> None:
        case = build_repair_case(_admitted_row())

        self.assertIsNotNone(case)
        assert case is not None
        self.assertEqual(case["benchmark_family"], "single_point_family_generalization_candidate")
    ...
    def test_run_family_generalization_screening_writes_outputs(self) -> None:
