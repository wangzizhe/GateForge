...
from gateforge.agent_modelica_methodology_closeout_v0_29_25 import build_methodology_closeout


class MethodologyCloseoutV02925Tests(unittest.TestCase):
    def test_build_closeout_summary_writes_outputs(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            out_dir = Path(tmp) / "out"
            summary = build_methodology_closeout(out_dir=out_dir)
