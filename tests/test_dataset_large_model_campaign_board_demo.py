...
class DatasetLargeModelCampaignBoardDemoTests(unittest.TestCase):
    def test_demo_dataset_large_model_campaign_board_script(self) -> None:
        repo_root = Path(__file__).resolve().parents[1]
        script = repo_root / "scripts" / "demo_dataset_large_model_campaign_board.sh"
