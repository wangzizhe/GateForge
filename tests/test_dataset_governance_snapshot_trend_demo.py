...
class DatasetGovernanceSnapshotTrendDemoTests(unittest.TestCase):
    def test_demo_dataset_governance_snapshot_trend_script(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            self.assertIn("->", str(payload.get("real_model_supply_pipeline_status_transition")))
            self.assertIn("->", str(payload.get("mutation_coverage_matrix_status_transition")))
            self.assertIn("->", str(payload.get("model_intake_board_history_status_transition")))
            self.assertIn("->", str(payload.get("model_intake_board_history_trend_status_transition")))
            self.assertIn("->", str(payload.get("anchor_model_pack_history_status_transition")))
            self.assertIn("->", str(payload.get("anchor_model_pack_history_trend_status_transition")))
            self.assertIn("->", str(payload.get("failure_matrix_expansion_history_status_transition")))
            self.assertIn("->", str(payload.get("failure_matrix_expansion_history_trend_status_transition")))
            ...
            self.assertIn("->", str(payload.get("model_asset_target_gap_history_status_transition")))
            self.assertIn("->", str(payload.get("model_asset_target_gap_history_trend_status_transition")))
