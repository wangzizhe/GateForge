...
class DatasetMutationExecutionAuthenticityHistoryLedgerV1Tests(unittest.TestCase):
        ...
        with tempfile.TemporaryDirectory() as d:
                ...
                json.dumps(
                    {
                        ...
                        "placeholder_executed_ratio_pct": 96.0,
            ...
            proc = subprocess.run(
                [
                    sys.executable,
                    "-m",
                    "gateforge.dataset_mutation_execution_authenticity_history_ledger_v1",
