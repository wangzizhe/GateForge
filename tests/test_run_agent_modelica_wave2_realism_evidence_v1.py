...
class RunAgentModelicaWave2RealismEvidenceV1Tests(unittest.TestCase):
    def test_mock_chain_produces_wave2_decision(self) -> None:
        repo_root = Path(__file__).resolve().parents[1]
        script = repo_root / "scripts" / "run_agent_modelica_wave2_realism_evidence_v1.sh"
        with tempfile.TemporaryDirectory() as d:
            ...
            proc = subprocess.run(
                ...
                env={
                    **os.environ,
                    ...
                    "GATEFORGE_AGENT_WAVE2_REALISM_EVIDENCE_OUT_DIR": str(out_dir),
                    "GATEFORGE_AGENT_WAVE2_REALISM_REPAIR_MEMORY": str(root / "missing_memory.json"),
                },
                timeout=900,
            )
            ...
            self.assertTrue((out_dir / "wave2_baseline_summary.json").exists())
