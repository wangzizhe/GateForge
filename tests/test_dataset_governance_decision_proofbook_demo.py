...
class DatasetGovernanceDecisionProofbookDemoTests(unittest.TestCase):
    def test_demo_dataset_governance_decision_proofbook_script(self) -> None:
        repo_root = Path(__file__).resolve().parents[1]
        script = repo_root / "scripts" / "demo_dataset_governance_decision_proofbook.sh"
