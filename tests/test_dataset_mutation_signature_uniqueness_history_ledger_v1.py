...
class DatasetMutationSignatureUniquenessHistoryLedgerV1Tests(unittest.TestCase):
        ...
        with tempfile.TemporaryDirectory() as d:
                ...
                json.dumps(
                    {
                        "status": "PASS",
                        "total_mutations": 120,
                        "unique_signatures": 118,
                        "duplicate_signatures": 2,
                        "unique_signature_ratio_pct": 98.3333,
                    }
                ),
                encoding="utf-8",
            )
            proc = subprocess.run(
                [
                    sys.executable,
                    "-m",
                    "gateforge.dataset_mutation_signature_uniqueness_history_ledger_v1",
