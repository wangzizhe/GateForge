...
Policy patch dashboard demo shortcut:
...
- Provides an optional invariant repair profile-compare demo job (shares `workflow_dispatch` toggle `run_invariant_repair_loop_demo=true`) that does not block the main job.
