...
def main() -> int:
    parser = argparse.ArgumentParser(description="Summarize v0.30.9 candidate structure attribution.")
    ...
    summary = build_candidate_structure_attribution(run_dirs=run_dirs, out_dir=args.out_dir)
