...
DEFAULT_MVP_PROFILE_PATH="benchmarks/agent_modelica_mvp_repair_v1.json"
if [ -f "benchmarks/private/agent_modelica_mvp_repair_v1.json" ]; then
  DEFAULT_MVP_PROFILE_PATH="benchmarks/private/agent_modelica_mvp_repair_v1.json"
fi
MVP_PROFILE_PATH="${GATEFORGE_AGENT_MVP_PROFILE_PATH:-$DEFAULT_MVP_PROFILE_PATH}"
...
if [ -f "policies/private/physics_contract_v0.json" ]; then
  DEFAULT_PHYSICS_CONTRACT_PATH="policies/private/physics_contract_v0.json"
fi
PHYSICS_CONTRACT="${GATEFORGE_AGENT_PHYSICS_CONTRACT:-$DEFAULT_PHYSICS_CONTRACT_PATH}"
