"""
Unified trajectory runner for the v0.19.4 mutation benchmark.
...
Usage:
    python3 scripts/run_benchmark_trajectory_v0_19_4.py [--benchmark JSONL] [--out-dir DIR]
"""
...
CANDIDATES_JSONL = REPO_ROOT / "artifacts" / "benchmark_v0_19_4" / "admitted_cases.jsonl"
DEFAULT_OUT_DIR = REPO_ROOT / "artifacts" / "benchmark_trajectory_v0_19_4"
