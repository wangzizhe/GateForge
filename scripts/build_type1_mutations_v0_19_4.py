"""
Build and OMC-verify Type 1 intra-layer multi-turn mutations for v0.19.4.
...
Outputs:
  artifacts/type1_mutations_v0_19_4/
...
OUT_DIR = REPO_ROOT / "artifacts" / "type1_mutations_v0_19_4"
...
MUTATION_SPECS = [
    {
        "candidate_id": "type1_2turn_x_tail_y_tail",
        "description": "2-turn: x tail typo (p7_final) then y tail typo (p14_v2)",
        "expected_turns": 2,
        "replacements": [("p7;", "p7_final;"), ("p14;", "p14_v2;")],
    },
    {
        "candidate_id": "type1_2turn_y_tail_z_tail",
        "description": "2-turn: y tail typo (p14_v2) then z tail typo (p21_orig)",
        "expected_turns": 2,
        "replacements": [("p14;", "p14_v2;"), ("p21;", "p21_orig;")],
    },
    {
        "candidate_id": "type1_2turn_x_mid_z_tail",
        "description": "2-turn: x mid typo (p4_old) then z tail typo (p21_orig)",
        "expected_turns": 2,
        "replacements": [("p4+", "p4_old+"), ("p21;", "p21_orig;")],
    },
    {
        "candidate_id": "type1_2turn_x_head_y_mid",
        "description": "2-turn: x head typo (p1_ref) then y mid typo (p11_copy)",
        "expected_turns": 2,
        "replacements": [("p1-", "p1_ref-"), ("p11+", "p11_copy+")],
    },
    {
        "candidate_id": "type1_2turn_y_head_z_mid",
        "description": "2-turn: y head typo (p8_ref) then z mid typo (p18_old)",
        "expected_turns": 2,
        "replacements": [("p8-", "p8_ref-"), ("p18+", "p18_old+")],
    },
    {
        "candidate_id": "type1_2turn_x_inner_y_inner",
        "description": "2-turn: x inner typo (p3_est) then y inner typo (p12_guess)",
        "expected_turns": 2,
        "replacements": [("p3-", "p3_est-"), ("p12-", "p12_guess-")],
    },
    {
        "candidate_id": "type1_2turn_y_inner_z_inner",
        "description": "2-turn: y inner typo (p10_nom) then z inner typo (p19_trial)",
        "expected_turns": 2,
        "replacements": [("p10-", "p10_nom-"), ("p19-","p19_trial-")],
    },
    {
        "candidate_id": "type1_3turn_xyz_tail",
        "description": "3-turn: x tail (p7_final), y tail (p14_v2), z tail (p21_orig)",
        "expected_turns": 3,
        "replacements": [("p7;", "p7_final;"), ("p14;", "p14_v2;"), ("p21;", "p21_orig;")],
    },
    {
        "candidate_id": "type1_3turn_xyz_mid",
        "description": "3-turn: x mid (p4_old), y mid (p11_copy), z mid (p18_old)",
        "expected_turns": 3,
        "replacements": [("p4+", "p4_old+"), ("p11+", "p11_copy+"), ("p18+", "p18_old+")],
    },
    {
        "candidate_id": "type1_3turn_xyz_head",
        "description": "3-turn: x head (p1_ref), y head (p8_ref), z head (p15_ref)",
        "expected_turns": 3,
        "replacements": [("p1-", "p1_ref-"), ("p8-", "p8_ref-"), ("p15-", "p15_ref-")],
    },
    {
        "candidate_id": "type1_3turn_xyz_inner_a",
        "description": "3-turn: x inner (p3_est), y inner (p10_nom), z inner (p17_nom)",
        "expected_turns": 3,
        "replacements": [("p3-", "p3_est-"), ("p10-", "p10_nom-"), ("p17-", "p17_nom-")],
    },
    {
        "candidate_id": "type1_3turn_xyz_inner_b",
        "description": "3-turn: x inner (p6_calc), y inner (p13_calc), z inner (p20_calc)",
        "expected_turns": 3,
        "replacements": [("p6+", "p6_calc+"), ("p13+", "p13_calc+"), ("p20+", "p20_calc+")],
    },
]
...
def _symbol_name(token: str) -> str:
    """Return the Modelica identifier from a mutated expression token."""
    return token.rstrip("+-;")
...
def _verify_candidate(spec: dict, source_text: str) -> dict:
    ...
    first_wrong = _symbol_name(wrong_tokens[0])  # e.g. "p14_v2"
    ...
    for turn_idx, wrong_token in enumerate(wrong_tokens, start=1):
        ...
        if is_last:
            ...
            next_wrong = _symbol_name(wrong_tokens[turn_idx])
