...
summary = {
    ...
    "require_min_pairwise_net_margin": pass_payload.get("require_min_pairwise_net_margin"),
    "source_require_min_pairwise_net_margin": pass_payload.get("source_require_min_pairwise_net_margin"),
