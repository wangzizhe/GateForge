...
DEFAULT_OUT_DIR = REPO_ROOT / "artifacts" / "structural_ambiguity_shifted_closure_admission_v0_78_1"


def main() -> int:
    parser = argparse.ArgumentParser(description="Run OMC admission for v0.78 shifted closure candidates.")
    parser.add_argument("--tasks", type=Path, default=DEFAULT_SHIFTED_CLOSURE_EXPANSION_OUT_DIR / "tasks.jsonl")
    ...
    summary["analysis_scope"] = "structural_ambiguity_shifted_closure_omc_admission"
