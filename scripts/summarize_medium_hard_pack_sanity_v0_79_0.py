...
from gateforge.agent_modelica_medium_hard_pack_sanity_v0_79_0 import (  # noqa: E402
    DEFAULT_OUT_DIR,
    DEFAULT_PACK_TASKS,
    build_medium_hard_pack_sanity_summary,
)


def main() -> int:
    parser = argparse.ArgumentParser(description="Build v0.79 paired sanity summary for the medium-hard pack.")
    ...
    parser.add_argument("--summary-version", default="v0.79.0")
