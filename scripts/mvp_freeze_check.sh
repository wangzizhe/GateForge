...
mkdir -p "$OUT_DIR"
rm -f "$OUT_DIR"/summary.json "$OUT_DIR"/summary.md "$OUT_DIR"/tests.log "$OUT_DIR"/medium_dashboard.log "$OUT_DIR"/mutation_dashboard.log "$OUT_DIR"/policy_dashboard.log "$OUT_DIR"/ci_matrix.log
