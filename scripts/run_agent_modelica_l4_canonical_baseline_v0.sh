...
BASELINE_PLANNER_BACKEND="${GATEFORGE_AGENT_L4_CANONICAL_BASELINE_PLANNER_BACKEND:-auto}"
BASELINE_LLM_MODEL="${GATEFORGE_AGENT_L4_CANONICAL_BASELINE_LLM_MODEL:-${LLM_MODEL:-}}"
