#!/usr/bin/env python3
"""Run baseline on hard_boundary_v3 cases."""
...
TASK_ROOT = REPO_ROOT / "assets_private" / "benchmarks" / "hard_boundary_v3" / "tasks" / "repair"
OUT_DIR = REPO_ROOT / "artifacts" / "hard_boundary_v3_baseline"

CASE_IDS = [
    "when_direction_01_event_semantics",
    "algorithm_scope_02_hybrid_semantics",
    "reinit_scope_03_state_semantics",
]
