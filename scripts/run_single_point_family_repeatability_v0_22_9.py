...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run v0.22.9 single-point family repeatability gate.")
    ...
    print(
        ...
        "true_multi={true_multi_observation_count} promoted={promoted_family_candidates}".format(**summary)
    )
