...
os.environ.setdefault("GATEFORGE_AGENT_LIVE_MAX_REQUESTS_PER_RUN", "12")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run v0.27.1 DeepSeek source-backed smoke slice.")
