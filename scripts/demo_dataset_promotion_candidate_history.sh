...
OUT_DIR="artifacts/dataset_promotion_candidate_history_demo"
mkdir -p "$OUT_DIR"
...
python3 -m gateforge.dataset_promotion_candidate_history \
  --record artifacts/dataset_promotion_candidate_demo/advisor.json \
  --record artifacts/dataset_promotion_candidate_demo/advisor.json \
...
python3 -m gateforge.dataset_promotion_candidate_history_trend \
...
out = Path("artifacts/dataset_promotion_candidate_history_demo")
...
summary = {
    ...
    "history_block_rate": history.get("block_rate"),
