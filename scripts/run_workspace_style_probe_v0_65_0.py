...
from gateforge.agent_modelica_workspace_style_probe_v0_65_0 import (
    DEFAULT_OUT_DIR,
    DEFAULT_TASKS,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the transparent workspace-style Modelica repair probe.")
    ...
    parser.add_argument("--summary-version", default="v0.66.0")
