...
DEFAULT_OUT_DIR = REPO_ROOT / "artifacts" / "structural_ambiguity_residual_closure_admission_v0_77_1"


def main() -> int:
    parser = argparse.ArgumentParser(description="Run OMC admission for v0.77 residual closure candidates.")
    parser.add_argument("--tasks", type=Path, default=DEFAULT_RESIDUAL_CLOSURE_EXPANSION_OUT_DIR / "tasks.jsonl")
    ...
    summary["analysis_scope"] = "structural_ambiguity_residual_closure_omc_admission"
