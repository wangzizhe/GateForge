...
export GATEFORGE_MIN_GENERATED_MUTATIONS="${GATEFORGE_MIN_GENERATED_MUTATIONS:-2500}"
export GATEFORGE_MIN_MUTATION_PER_MODEL="${GATEFORGE_MIN_MUTATION_PER_MODEL:-10}"
export GATEFORGE_MIN_REPRODUCIBLE_MUTATIONS="${GATEFORGE_MIN_REPRODUCIBLE_MUTATIONS:-1800}"
export GATEFORGE_MUTATIONS_PER_FAILURE_TYPE="${GATEFORGE_MUTATIONS_PER_FAILURE_TYPE:-6}"
export GATEFORGE_PRIVATE_BATCH_OUT_DIR="${GATEFORGE_PRIVATE_BATCH_OUT_DIR:-artifacts/private_model_mutation_scale_depth6_sprint_v1}"

BASELINE_SUMMARY="${GATEFORGE_BASELINE_SCALE_SUMMARY:-artifacts/private_model_mutation_scale_depth4_sprint_v1/summary.json}"
...
python3 -m gateforge.dataset_mutation_depth_upgrade_report_v1 \
  ...
  --target-mutations-per-failure-type 6 \
  --min-generated-multiplier 1.4 \
