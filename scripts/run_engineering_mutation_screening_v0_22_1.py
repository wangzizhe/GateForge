...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run v0.22.1 engineering mutation multi-turn screening.")
    ...
    print(
        "cases={total_cases} pass={pass_count} multi_turn={multi_turn_useful_count} "
