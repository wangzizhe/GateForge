    ...
    results.append(
        {
            ...
            "category_breakdown_on": on.get("category_breakdown") if isinstance(on.get("category_breakdown"), dict) else {},
            "failure_type_breakdown_on": on.get("failure_type_breakdown") if isinstance(on.get("failure_type_breakdown"), dict) else {},
            "category_breakdown_delta": delta.get("category_breakdown") if isinstance(delta.get("category_breakdown"), dict) else {},
            "failure_type_breakdown_delta": delta.get("failure_type_breakdown") if isinstance(delta.get("failure_type_breakdown"), dict) else {},
            "reasons": reasons,
...
summary = {
    ...
    "category_breakdown": best.get("category_breakdown_on") if isinstance(best, dict) and isinstance(best.get("category_breakdown_on"), dict) else {},
    "failure_type_breakdown": best.get("failure_type_breakdown_on") if isinstance(best, dict) and isinstance(best.get("failure_type_breakdown_on"), dict) else {},
    "delta_category_breakdown": best.get("category_breakdown_delta") if isinstance(best, dict) and isinstance(best.get("category_breakdown_delta"), dict) else {},
    "delta_failure_type_breakdown": best.get("failure_type_breakdown_delta") if isinstance(best, dict) and isinstance(best.get("failure_type_breakdown_delta"), dict) else {},
