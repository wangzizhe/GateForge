...
DEFAULT_OUT_DIR = REPO_ROOT / "artifacts" / "dyad_ab_summary_v0_29_11"
...
def build_dyad_ab_summary(*, arm_dirs: dict[str, Path], out_dir: Path = DEFAULT_OUT_DIR) -> dict[str, Any]:
    ...
    summary = {
        ...
        "analysis_scope": "dyad_methodology_ab_summary",
        ...
        "cases": case_rows,
        "decision": (
            "dyad_ab_has_net_positive_delta"
            if positive_arms
            else "dyad_ab_has_mixed_delta_no_net_gain"
            if mixed_arms
            else "dyad_ab_no_positive_delta_observed"
        ),
        "discipline": {
