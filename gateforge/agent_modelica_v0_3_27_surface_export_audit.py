...
def build_v0327_surface_export_audit(
    *,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the v0.3.27 neighbor-component local-interface discovery surface export audit.")
    ...
    payload = build_v0327_surface_export_audit(
