...
def build_v0326_surface_export_audit(
    *,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the v0.3.26 component-type local-interface discovery surface export audit.")
    ...
    payload = build_v0326_surface_export_audit(
