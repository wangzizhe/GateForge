...
SCHEMA_VERSION = "agent_modelica_v0_3_10_comparative_reopen_checkpoint"
DEFAULT_OUT_DIR = "artifacts/agent_modelica_v0_3_10_comparative_reopen_checkpoint"
...
def build_v0_3_10_comparative_reopen_checkpoint(
    *,
    ...
    _write_text(out_root / "summary.md", "\n".join(["# v0.3.10 Comparative Reopen Checkpoint", "", "- decision: `DEFER`", ""]))
    return payload


def main() -> None:
    parser = argparse.ArgumentParser(description="Build the v0.3.10 comparative reopen checkpoint artifact.")
    parser.add_argument("--block-b-decision-summary", required=True)
    parser.add_argument("--out-dir", default=DEFAULT_OUT_DIR)
    args = parser.parse_args()
    payload = build_v0_3_10_comparative_reopen_checkpoint(
