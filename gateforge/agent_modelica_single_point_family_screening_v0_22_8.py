...
DEFAULT_OUT_DIR = REPO_ROOT / "artifacts" / "single_point_family_screening_v0_22_8"


def build_repair_case(row: dict[str, Any]) -> dict[str, Any] | None:
    if row.get("target_admission_status") != "admitted_single_point_family_failure":
        return None
    ...
    return {
        ...
        "benchmark_family": "single_point_family_generalization_candidate",
        "mutation_family": str(row.get("mutation_pattern") or ""),
        "benchmark_version": "v0.22.8",
        ...
        "admission_source": "omc_single_point_family_verified",
    }
...
def run_family_generalization_screening(
    *,
    ...
    for index, case in enumerate(cases, start=1):
        ...
        report = {
            ...
            "analysis_scope": "live_true_multiturn_screening_for_single_point_family_generalization",
