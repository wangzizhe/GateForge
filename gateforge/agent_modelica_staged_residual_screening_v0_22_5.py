...
DEFAULT_ADMISSION_PATH = REPO_ROOT / "artifacts" / "staged_residual_pack_v0_22_4" / "staged_candidates.jsonl"
DEFAULT_OUT_DIR = REPO_ROOT / "artifacts" / "staged_residual_screening_v0_22_5"


def build_repair_case(row: dict[str, Any]) -> dict[str, Any] | None:
    if row.get("target_admission_status") != "admitted_staged_residual_failure":
        return None
    ...
    return {
        ...
        "benchmark_family": "staged_residual_true_multiturn_candidate",
        "mutation_family": str(row.get("mutation_pattern") or ""),
        "benchmark_version": "v0.22.5",
...
def run_staged_residual_screening(
    *,
    ...
    for index, case in enumerate(cases, start=1):
        ...
        report = {
            ...
            "analysis_scope": "live_true_multiturn_screening_for_staged_residuals",
