    ...
    required = [
        ...
        (
            ...
            [
                ...
                "failure_distribution_stability_history_status",
                "failure_distribution_stability_history_avg_stability_score",
                "failure_distribution_stability_history_trend_status",
                "moat_anchor_brief_status",
                "moat_anchor_brief_score",
                "moat_anchor_brief_recommendation",
                "moat_anchor_brief_history_status",
                "moat_anchor_brief_history_publish_rate",
                "moat_anchor_brief_history_trend_status",
                "real_model_supply_pipeline_status",
                "real_model_supply_pipeline_score",
                "real_model_supply_pipeline_new_models_30d",
                "mutation_coverage_matrix_status",
                "mutation_coverage_matrix_score",
                "mutation_coverage_matrix_high_risk_uncovered_cells",
                "model_intake_board_history_status",
                "model_intake_board_history_avg_board_score",
                "model_intake_board_history_trend_status",
                "anchor_model_pack_history_status",
                "anchor_model_pack_history_avg_pack_quality_score",
                "anchor_model_pack_history_trend_status",
        ...
        (
            ...
            [
                ...
                "failure_distribution_stability_history_status_transition",
                "failure_distribution_stability_history_trend_status_transition",
                "moat_anchor_brief_status_transition",
                "moat_anchor_brief_history_status_transition",
                "moat_anchor_brief_history_trend_status_transition",
                "real_model_supply_pipeline_status_transition",
                "mutation_coverage_matrix_status_transition",
                "model_intake_board_history_status_transition",
                "model_intake_board_history_trend_status_transition",
                "anchor_model_pack_history_status_transition",
        ...
        (
            "dataset_failure_distribution_stability_history_v1_demo",
        ...
        (
            "dataset_failure_distribution_stability_history_trend_v1_demo",
        ...
        (
            "dataset_real_model_supply_pipeline_v1_demo",
            "dataset_real_model_supply_pipeline_v1_demo/demo_summary.json",
            [
                "bundle_status",
                "supply_pipeline_status",
                "supply_pipeline_score",
                "new_models_30d",
                "large_model_candidates_30d",
                "license_blockers",
            ],
        ),
        (
            "dataset_mutation_coverage_matrix_v2_demo",
            "dataset_mutation_coverage_matrix_v2_demo/demo_summary.json",
            [
                "bundle_status",
                "matrix_status",
                "matrix_coverage_score",
                "total_matrix_cells",
        ...
        (
            "dataset_moat_anchor_brief_history_v1_demo",
            "dataset_moat_anchor_brief_history_v1_demo/demo_summary.json",
            ["bundle_status", "history_status", "total_records", "avg_anchor_brief_score"],
        ),
        (
            "dataset_moat_anchor_brief_history_trend_v1_demo",
