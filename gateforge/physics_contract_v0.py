...
DEFAULT_PUBLIC_PHYSICS_CONTRACT_PATH = "policies/physics_contract_v0.json"
DEFAULT_PRIVATE_PHYSICS_CONTRACT_PATH = "policies/private/physics_contract_v0.json"
DEFAULT_PHYSICS_CONTRACT_PATH = (
    DEFAULT_PRIVATE_PHYSICS_CONTRACT_PATH
    if Path(DEFAULT_PRIVATE_PHYSICS_CONTRACT_PATH).exists()
    else DEFAULT_PUBLIC_PHYSICS_CONTRACT_PATH
)
