...
def _difficulty_row(preview_row: dict, admitted_index: int) -> dict:
    if not preview_row["preview_admission"]:
        return {
            ...
            "task_id": preview_row.get("task_id", ""),
            "source_case_id": preview_row.get("source_case_id", ""),
            "source_model_path": preview_row.get("source_model_path", ""),
            "mutated_model_path": preview_row.get("mutated_model_path", ""),
            "failure_type": preview_row.get("failure_type", ""),
            "expected_stage": preview_row.get("expected_stage", ""),
            "workflow_goal": preview_row.get("workflow_goal", ""),
            "planner_backend": preview_row.get("planner_backend", ""),
            "backend": preview_row.get("backend", ""),
            "scale": preview_row.get("scale", ""),
