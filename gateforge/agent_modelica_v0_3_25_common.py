...
from .agent_modelica_v0_3_24_common import (
    DUAL_RECHECK_SPECS as V0324_DUAL_RECHECK_SPECS,
    SINGLE_MISMATCH_SPECS as V0324_SINGLE_MISMATCH_SPECS,
    build_v0324_source_specs,
)


SCHEMA_PREFIX = "agent_modelica_v0_3_25"
REPO_ROOT = Path(__file__).resolve().parents[1]

DEFAULT_MANIFEST_OUT_DIR = REPO_ROOT / "artifacts" / "agent_modelica_v0_3_25_coverage_manifest_current"
DEFAULT_SURFACE_INDEX_OUT_DIR = REPO_ROOT / "artifacts" / "agent_modelica_v0_3_25_surface_index_current"
DEFAULT_SURFACE_AUDIT_OUT_DIR = REPO_ROOT / "artifacts" / "agent_modelica_v0_3_25_surface_export_audit_current"
DEFAULT_TASKSET_OUT_DIR = REPO_ROOT / "artifacts" / "agent_modelica_v0_3_25_taskset_current"
DEFAULT_PATCH_CONTRACT_OUT_DIR = REPO_ROOT / "artifacts" / "agent_modelica_v0_3_25_patch_contract_current"
DEFAULT_FIRST_FIX_RESULTS_DIR = REPO_ROOT / "artifacts" / "agent_modelica_v0_3_25_first_fix_results_current"
DEFAULT_FIRST_FIX_OUT_DIR = REPO_ROOT / "artifacts" / "agent_modelica_v0_3_25_first_fix_evidence_current"
DEFAULT_DUAL_RECHECK_RESULTS_DIR = REPO_ROOT / "artifacts" / "agent_modelica_v0_3_25_dual_recheck_results_current"
DEFAULT_DUAL_RECHECK_OUT_DIR = REPO_ROOT / "artifacts" / "agent_modelica_v0_3_25_dual_recheck_current"
DEFAULT_CLOSEOUT_OUT_DIR = REPO_ROOT / "artifacts" / "agent_modelica_v0_3_25_closeout_current"


def _clone_spec_with_v0325_id(spec: dict) -> dict:
    updated = dict(spec)
    updated["task_id"] = norm(spec.get("task_id")).replace("v0324_", "v0325_", 1)
    return updated


ADDITIONAL_SINGLE_MISMATCH_SPECS = [
    {
        "task_id": "v0325_single_simple_spring_leftflange",
        ...
        "correct_symbol": "spring.flange_a",
        "candidate_key": "spring.leftFlange",
        "injection_replacements": [("connect(fixed.flange, spring.flange_a);", "connect(fixed.flange, spring.leftFlange);")],
    },
    {
        "task_id": "v0325_single_simple_spring_rightflange",
        "source_id": "simple_sine_driven_mass",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        "patch_type": "replace_connect_endpoint",
        "wrong_symbol": "spring.rightFlange",
        "correct_symbol": "spring.flange_b",
        "candidate_key": "spring.rightFlange",
        "injection_replacements": [("connect(spring.flange_b, mass.flange_a);", "connect(spring.rightFlange, mass.flange_a);")],
    },
    {
        "task_id": "v0325_single_simple_damper_leftflange",
        "source_id": "simple_sine_driven_mass",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        "patch_type": "replace_connect_endpoint",
        "wrong_symbol": "damper.leftFlange",
        "correct_symbol": "damper.flange_a",
        "candidate_key": "damper.leftFlange",
        "injection_replacements": [("connect(damper.flange_a, fixed.flange);", "connect(damper.leftFlange, fixed.flange);")],
    },
    {
        "task_id": "v0325_single_simple_damper_rightflange",
        "source_id": "simple_sine_driven_mass",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        "patch_type": "replace_connect_endpoint",
        "wrong_symbol": "damper.rightFlange",
        "correct_symbol": "damper.flange_b",
        "candidate_key": "damper.rightFlange",
        "injection_replacements": [("connect(damper.flange_b, mass.flange_a);", "connect(damper.rightFlange, mass.flange_a);")],
    },
    {
        "task_id": "v0325_single_simple_thermal_resistor_portleft",
        "source_id": "simple_thermal_heated_mass",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        "patch_type": "replace_connect_endpoint",
        "wrong_symbol": "resistor.portLeft",
        "correct_symbol": "resistor.port_a",
        "candidate_key": "resistor.portLeft",
        "injection_replacements": [("connect(mass.port, resistor.port_a);", "connect(mass.port, resistor.portLeft);")],
    },
    {
        "task_id": "v0325_single_simple_thermal_resistor_portright",
        "source_id": "simple_thermal_heated_mass",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        "patch_type": "replace_connect_endpoint",
        "wrong_symbol": "resistor.portRight",
        "correct_symbol": "resistor.port_b",
        "candidate_key": "resistor.portRight",
        "injection_replacements": [("connect(resistor.port_b, ambient.port);", "connect(resistor.portRight, ambient.port);")],
    },
    {
        "task_id": "v0325_single_medium_controller_inputsignal",
        ...
        "wrong_symbol": "controller.inputSignal",
        "correct_symbol": "controller.u",
        "candidate_key": "controller.inputSignal",
        "injection_replacements": [("connect(feedback.y, controller.u);", "connect(feedback.y, controller.inputSignal);")],
    },
    {
        "task_id": "v0325_single_medium_controller_out",
        "source_id": "medium_mass_spring_position_control",
        "complexity_tier": "medium",
        "component_family": "local_signal_port_alignment",
        "patch_type": "replace_local_port_symbol",
        "wrong_symbol": "controller.out",
        "correct_symbol": "controller.y",
        "candidate_key": "controller.out",
        "injection_replacements": [("connect(controller.y, actuator.u);", "connect(controller.out, actuator.u);")],
    },
    {
        "task_id": "v0325_single_simple_electrical_resistor_pospin",
        "source_id": "simple_electrical_sine_rl",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        "patch_type": "replace_connect_endpoint",
        "wrong_symbol": "resistor.posPin",
        "correct_symbol": "resistor.p",
        "candidate_key": "resistor.posPin",
        "injection_replacements": [("connect(source.p, resistor.p);", "connect(source.p, resistor.posPin);")],
    },
    {
        "task_id": "v0325_single_simple_electrical_resistor_negpin",
        "source_id": "simple_electrical_sine_rl",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        "patch_type": "replace_connect_endpoint",
        "wrong_symbol": "resistor.negPin",
        "correct_symbol": "resistor.n",
        "candidate_key": "resistor.negPin",
        "injection_replacements": [("connect(resistor.n, inductor.p);", "connect(resistor.negPin, inductor.p);")],
    },
    {
        "task_id": "v0325_single_simple_electrical_inductor_pospin",
        "source_id": "simple_electrical_sine_rl",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        "patch_type": "replace_connect_endpoint",
        "wrong_symbol": "inductor.posPin",
        "correct_symbol": "inductor.p",
        "candidate_key": "inductor.posPin",
        "injection_replacements": [("connect(resistor.n, inductor.p);", "connect(resistor.n, inductor.posPin);")],
    },
    {
        "task_id": "v0325_single_simple_electrical_inductor_negpin",
        "source_id": "simple_electrical_sine_rl",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        "patch_type": "replace_connect_endpoint",
        "wrong_symbol": "inductor.negPin",
        "correct_symbol": "inductor.n",
        "candidate_key": "inductor.negPin",
        "injection_replacements": [("connect(inductor.n, source.n);", "connect(inductor.negPin, source.n);")],
    },
]
...
ADDITIONAL_DUAL_RECHECK_SPECS = [
    {
        "task_id": "v0325_dual_simple_spring_component",
        "source_id": "simple_sine_driven_mass",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        ...
        "injection_replacements": [
            ("connect(fixed.flange, spring.flange_a);", "connect(fixed.flange, spring.leftFlange);"),
            ("connect(spring.flange_b, mass.flange_a);", "connect(spring.rightFlange, mass.flange_a);"),
        ],
    },
    {
        "task_id": "v0325_dual_simple_damper_component",
        "source_id": "simple_sine_driven_mass",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        "placement_kind": "same_component_dual_mismatch",
        ...
        "injection_replacements": [
            ("connect(damper.flange_a, fixed.flange);", "connect(damper.leftFlange, fixed.flange);"),
            ("connect(damper.flange_b, mass.flange_a);", "connect(damper.rightFlange, mass.flange_a);"),
        ],
    },
    {
        "task_id": "v0325_dual_simple_thermal_resistor_component",
        "source_id": "simple_thermal_heated_mass",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        "placement_kind": "same_component_dual_mismatch",
        ...
        "injection_replacements": [
            ("connect(mass.port, resistor.port_a);", "connect(mass.port, resistor.portLeft);"),
            ("connect(resistor.port_b, ambient.port);", "connect(resistor.portRight, ambient.port);"),
        ],
    },
    {
        "task_id": "v0325_dual_medium_controller_component",
        "source_id": "medium_mass_spring_position_control",
        "complexity_tier": "medium",
        "component_family": "local_signal_port_alignment",
        "placement_kind": "same_component_dual_mismatch",
    ...
    {
        "task_id": "v0325_dual_simple_electrical_resistor_component",
        "source_id": "simple_electrical_sine_rl",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        "placement_kind": "same_component_dual_mismatch",
    ...
    {
        "task_id": "v0325_dual_simple_electrical_inductor_component",
        "source_id": "simple_electrical_sine_rl",
        "complexity_tier": "simple",
        "component_family": "local_connector_side_alignment",
        "placement_kind": "same_component_dual_mismatch",
        ...
        "injection_replacements": [
            ...
            ("connect(inductor.n, source.n);", "connect(inductor.negPin, source.n);"),
        ],
    },
]


SINGLE_MISMATCH_SPECS = [_clone_spec_with_v0325_id(spec) for spec in V0324_SINGLE_MISMATCH_SPECS] + [
    dict(spec) for spec in ADDITIONAL_SINGLE_MISMATCH_SPECS
]

DUAL_RECHECK_SPECS = [_clone_spec_with_v0325_id(spec) for spec in V0324_DUAL_RECHECK_SPECS] + [
...
def build_v0325_source_specs() -> list[dict]:
    return [dict(row) for row in build_v0324_source_specs()]


def _source_row(source_id: str) -> dict:
    for row in build_v0325_source_specs():
...
def build_surface_index_payload(*, use_fixture_only: bool = False) -> dict:
    ...
    source_specs = build_v0325_source_specs()
