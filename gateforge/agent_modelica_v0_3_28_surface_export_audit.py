...
def build_v0328_surface_export_audit(
    *,
    ...
    summary = {
        ...
        "coverage_construction_mode": norm(taskset_summary.get("coverage_construction_mode")),
        "neighbor_post_first_fix_target_bucket_hit_rate_pct": float(taskset_summary.get("neighbor_post_first_fix_target_bucket_hit_rate_pct") or 0.0),
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the v0.3.28 widened neighbor-component local-interface discovery surface export audit.")
    ...
    payload = build_v0328_surface_export_audit(
        ...
        json.dumps(
            {
                ...
                "surface_export_success_rate_pct": summary.get("surface_export_success_rate_pct"),
                "export_excluded_count": summary.get("export_excluded_count"),
            }
        )
    )
    return 0
