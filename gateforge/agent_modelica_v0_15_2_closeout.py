...
from .agent_modelica_v0_15_2_meaning_synthesis import build_v152_meaning_synthesis
from .agent_modelica_v0_15_2_phase_ledger import build_v152_phase_ledger
from .agent_modelica_v0_15_2_stop_condition import build_v152_stop_condition


def build_v152_closeout(
    *,
    ...
    if ledger.get("phase_ledger_status") == "invalid":
        payload = {
            ...
            "status": "FAIL",
            "closeout_status": "V0_15_2_HANDOFF_PHASE_INPUTS_INVALID",
            "conclusion": {
                "version_decision": "v0_15_2_handoff_phase_inputs_invalid",
                "v0_16_primary_phase_question": "rebuild_v0_15_phase_inputs_first",
            },
            "phase_ledger": ledger,
        }
        write_json(out_root / "summary.json", payload)
        write_text(out_root / "summary.md", "# v0.15.2 Closeout\n\n- version_decision: `v0_15_2_handoff_phase_inputs_invalid`\n")
        return payload
    ...
    do_not_continue = bool(synthesis.get("do_not_continue_v0_15_same_even_broader_refinement_by_default"))
    next_q = str(synthesis.get("next_primary_phase_question") or NEXT_PRIMARY_PHASE_QUESTION)

    if stop_status == "met":
        version_decision = "v0_15_2_handoff_phase_inputs_invalid"
        v0_16_primary_phase_question = "met_path_not_yet_in_scope_for_v0_15_2"
        status = "FAIL"
        closeout_status = "V0_15_2_HANDOFF_PHASE_INPUTS_INVALID"
        ...
        v0_16_primary_phase_question = next_q
        status = "PASS"
        closeout_status = "V0_15_PHASE_NEARLY_COMPLETE_WITH_EXPLICIT_CAVEAT"
    elif stop_status == "not_ready_for_closeout":
        version_decision = "v0_15_phase_not_ready_for_closeout"
        v0_16_primary_phase_question = "resolve_v0_15_phase_incompleteness_first"
        status = "FAIL"
        closeout_status = "V0_15_PHASE_NOT_READY_FOR_CLOSEOUT"
    else:
        version_decision = "v0_15_2_handoff_phase_inputs_invalid"
        v0_16_primary_phase_question = "rebuild_v0_15_phase_inputs_first"
        status = "FAIL"
    ...
    payload = {
        ...
        "conclusion": {
            ...
            "why_v0_15_is_or_is_not_phase_complete": synthesis.get("why_this_phase_is_or_is_not_closeable"),
            "v0_16_primary_phase_question": v0_16_primary_phase_question,
        },
        "phase_ledger": ledger,
    ...
    write_text(
        ...
        "\n".join(
            [
                ...
                f"- v0_16_primary_phase_question: `{v0_16_primary_phase_question}`",
            ]
        ),
    )
    return payload
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build the v0.15.2 phase synthesis closeout.")
