...
def _write_markdown(path: str, payload: dict) -> None:
    ...
    lines = [
        "# GateForge Dataset Promotion Candidate Apply History Trend",
        "",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare dataset promotion apply history summaries and emit trend deltas")
    parser.add_argument("--current", required=True)
    parser.add_argument("--previous", required=True)
    parser.add_argument("--out", default="artifacts/dataset_promotion_candidate_apply_history/trend.json")
