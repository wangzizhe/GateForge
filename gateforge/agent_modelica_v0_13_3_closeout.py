...
from .agent_modelica_v0_13_3_meaning_synthesis import build_v133_meaning_synthesis
from .agent_modelica_v0_13_3_phase_ledger import build_v133_phase_ledger
from .agent_modelica_v0_13_3_stop_condition import build_v133_stop_condition


def build_v133_closeout(
    *,
    ...
    if not phase_ledger_file.exists():
        build_v133_phase_ledger(
            ...
            v132_closeout_path=v132_closeout_path,
    ...
    if ledger.get("phase_ledger_status") == "invalid":
        payload = {
            ...
            "status": "FAIL",
            "closeout_status": "V0_13_3_HANDOFF_PHASE_INPUTS_INVALID",
            "conclusion": {
                "version_decision": "v0_13_3_handoff_phase_inputs_invalid",
                "v0_14_primary_phase_question": "rebuild_v0_13_phase_inputs_first",
            },
            "phase_ledger": ledger,
        }
        write_json(out_root / "summary.json", payload)
        write_text(out_root / "summary.md", "# v0.13.3 Closeout\n\n- version_decision: `v0_13_3_handoff_phase_inputs_invalid`\n")
        return payload
    ...
    do_not_continue = bool(synthesis.get("do_not_continue_v0_13_same_capability_intervention_refinement_by_default"))
    next_q = str(synthesis.get("next_primary_phase_question") or NEXT_PRIMARY_PHASE_QUESTION)

    if stop_status == "met":
        # This is not a malformed input in the abstract; it is a future-reserved path that should
        # not appear under current v0.13.3 semantics, so we route it through the invalid branch.
        version_decision = "v0_13_3_handoff_phase_inputs_invalid"
        v0_14_primary_phase_question = "met_path_not_yet_in_scope_for_v0_13_3"
        status = "FAIL"
        closeout_status = "V0_13_3_HANDOFF_PHASE_INPUTS_INVALID"
        ...
        v0_14_primary_phase_question = next_q
        status = "PASS"
        closeout_status = "V0_13_PHASE_NEARLY_COMPLETE_WITH_EXPLICIT_CAVEAT"
    elif stop_status == "not_ready_for_closeout":
        version_decision = "v0_13_phase_not_ready_for_closeout"
        v0_14_primary_phase_question = "resolve_v0_13_phase_incompleteness_first"
        status = "FAIL"
        closeout_status = "V0_13_PHASE_NOT_READY_FOR_CLOSEOUT"
    else:
        version_decision = "v0_13_3_handoff_phase_inputs_invalid"
        v0_14_primary_phase_question = "rebuild_v0_13_phase_inputs_first"
        status = "FAIL"
    ...
    payload = {
        ...
        "conclusion": {
            ...
            "why_v0_13_is_or_is_not_phase_complete": synthesis.get("why_this_phase_is_or_is_not_closeable"),
            "v0_14_primary_phase_question": v0_14_primary_phase_question,
        },
        "phase_ledger": ledger,
    ...
    write_text(
        ...
        "\n".join(
            [
                ...
                f"- v0_14_primary_phase_question: `{v0_14_primary_phase_question}`",
            ]
        ),
    )
    return payload
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build the v0.13.3 phase synthesis closeout.")
